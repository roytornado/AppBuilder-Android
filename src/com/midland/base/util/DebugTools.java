...
public class DebugTools {
    ...
    public static void heapSize() {
        Common.v("Native Heap Total: " + humanReadableByteCount(Debug.getNativeHeapSize(), true) + " Allocated: " + humanReadableByteCount(Debug.getNativeHeapAllocatedSize(), true) + " Free: " + humanReadableByteCount(Debug.getNativeHeapFreeSize(), true));
    }
